...
const SLOG_MSG_GNSS_OPEN = 5;
const SLOG_MSG_GNSS_CLOSE = 6;
...
const PCM_LOG_OPEN = 'AT+SPDSP=65535,0,0,4096';
const PCM_LOG_CLOSE = 'AT+SPDSP=65535,0,0,0';

const ARM_LOG_ENABLE = 'AT+ARMLOG=1';
const ARM_LOG_DISABLE = 'AT+ARMLOG=0';

const SPDSPOP_ENABLE = 'AT+SPDSPOP=2';
const SPDSPOP_DISABLE = 'AT+SPDSPOP=0';
 ...
 * @type {string}
 */
const SLOG_CLEAN = 'cplogctl clear\n';
...
const SLOG_ENABLE_5MODE = 'cplogctl enable 5mode';
const SLOG_ENABLE_GNSS = 'cplogctl enable gnss';
const SLOG_ENABLE_WCN = 'cplogctl enable wcn';
const SLOG_ENABLE_TD = 'cplogctl enable td';
const SLOG_ENABLE_TDD_LTE = 'cplogctl enable fdd_lte';
const SLOG_ENABLE_FDD_LTE = 'cplogctl enable fdd_lte';
const SLOG_ENABLE_WCDMA = 'cplogctl enable wcdma';
...
const SLOG_DISABLE_5MODE = 'cplogctl disable 5mode';
const SLOG_DISABLE_GNSS = 'cplogctl disable gnss';
const SLOG_DISABLE_WCN = 'cplogctl disable wcn';
const SLOG_DISABLE_TD = 'cplogctl disable td';
const SLOG_DISABLE_TDD_LTE = 'cplogctl disable tdd_lte';
const SLOG_DISABLE_FDD_LTE = 'cplogctl disable fdd_lte';
const SLOG_DISABLE_WCDMA = 'cplogctl disable wcdma';
...
const SLOG_GET_5MODE_STATE = 'cplogctl state 5mode';
...
const CAP_LOG_ENABLE = 'AT+SPCAPLOG=1';
const CAP_LOG_DISABLE = 'AT+SPCAPLOG=0';
...
const WCND_START_ENGPC = 'wcn startengpc';

const WCND_STOP_ENGPC = 'wcn stopengpc';
